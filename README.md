...
**Важное замечание.** Метрики валидационные. Дообученная строка отобрана по
лучшему `CMC@8` на этой же валидации (лучший чекпоинт за 20 эпох), так что её
числа скорее завышены - отдельного теста не выделялось. У предобученных строк
этого перекоса нет: на валидации ничего не обучалось и не подбиралось.
